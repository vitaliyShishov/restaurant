...
<link type="text/css" href="view/stylesheet/stylesheet.css" rel="stylesheet" media="screen" />
  <script type="text/javascript" src="view/javascript/jqplot/jquery.jqplot.js"></script>
  <script type="text/javascript" src="view/javascript/jqplot/plugins/jqplot.canvasTextRenderer.js"></script>
  <script type="text/javascript" src="view/javascript/jqplot/plugins/jqplot.canvasAxisLabelRenderer.js"></script>
  <script type="text/javascript" src="view/javascript/jqplot/plugins/jqplot.pieRenderer.js"></script>
  <script type="text/javascript" src="view/javascript/jqplot/plugins/jqplot.highlighter.js"></script>
  <script type="text/javascript" src="view/javascript/jqplot/plugins/jqplot.cursor.js"></script>
  <script type="text/javascript" src="view/javascript/jqplot/plugins/jqplot.dateAxisRenderer.js"></script>
  <link rel="stylesheet" type="text/css" href="view/javascript/jqplot/jquery.jqplot.css" />
...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img src="view/image/logo_min.png" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
