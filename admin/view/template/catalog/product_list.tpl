          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <div class="form-group" style="display: none">
                ...
                <input type="text" name="filter_weight" value="<?php echo $filter_weight; ?>" placeholder="<?php echo $entry_weight; ?>" id="input-weight" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'pd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left" style="display: none;" ><?php if ($sort == 'p.model') { ?>
                  ...
                  <td class="text-right"><?php if ($sort == 'p.price') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right" style="display:none;"><?php if ($sort == 'p.quantity') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($product['special']) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right" style="display:none"><?php if ($product['quantity'] <= 0) { ?>
                    <span class="label label-warning"><?php echo $product['quantity']; ?></span>
                    <?php } elseif ($product['quantity'] <= 5) { ?>
                    <span class="label label-danger"><?php echo $product['quantity']; ?></span>
                    <?php } else { ?>
                    <span class="label label-success" style="display:none;"><?php echo $product['quantity']; ?></span>
                    <?php } ?></td>
