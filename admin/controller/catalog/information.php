...
class ControllerCatalogInformation extends Controller {
	...
	protected function getForm()
    {
        ...
        // Image
        if (isset($this->request->post['information_description'])) {
            $data['image'] = $this->model_catalog_information->getInformationImage($this->request->post['information_id']);
        } else if (isset($this->request->get['information_id'])) {
            $data['image'] = $this->model_catalog_information->getInformationImage($this->request->get['information_id']);
        } else {
            $data['image'] = '';
        }
